  ...
  return (
    ...
    text-center sm:mb-0 scroll-mt-[100rem]'>
            ...
            <div className='relative'>
                <motion.div 
                 ...
                 transition={{type: "tween", duration: 0.2}}>
                    <Image
                    src="https://media.licdn.com/dms/image/C4D03AQHxspIg66g8og/profile-displayphoto-shrink_200_200/0/1661808724774?e=1712188800&v=beta&t=skK_xsphEYTxW5lj_abt-DFhgE-BE632Gg5gSExfZEI"
                    alt="Liam portrait"
                    width="192"
                    height="192"
                    quality="95"
        ...
        transition={{ delay:0.1, }}>
            <Link href="#contact" className='group bg-gray-900 text-white px-8 py-3
            ...
            <a className='group bg-white px-8 py-3
             flex items-center gap-2 rounded-full outline-none 
             focus:scale-[1.15] hover:text-gray-950 hover:scale-[1.15] active:scale-105 
             transition cursor-pointer borderBlack dark:bg-white/10' href='/Liam_Gabriely__Resume.pdf' download>
            ...
            <a className='bg-white p-4 text-gray-700
             ...
             href='https://www.linkedin.com/in/liam-gabriely/' target='_blank'>
                <BsLinkedin />
            </a>

            <a className='bg-white p-4 text-gray-700 text-[1.35rem]
             flex items-center gap-2 rounded-full 
             focus:scale-110 hover:scale-110 active:scale-105 
             transition cursor-pointer borderBlack 
             dark:bg-white/10 dark:text-white/60'
             href='https://github.com/liamsei1' target='_blank'>
                <FaGithubSquare />
            </a>
